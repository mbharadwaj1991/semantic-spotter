...
1. The policy documents can be found [here](./Policy_Documents)
...
- Clone the github repository
  ```shell
  $ git clone https://github.com/mbharadwaj1991/semantic-spotter
  ```
- Open
  the [notebook](https://github.com/mbharadwaj1991/semantic-spotter/blob/main/semantic-spotter-rag.ipynb)
